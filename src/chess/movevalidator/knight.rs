...
impl MoveValidator {
    pub fn validate_knight_move(src: Square, dst: Square, chess: &Chess) -> bool {
        ...
        let src_knight = chess.get_piece_at_square(src).unwrap();
        let src_knight_color = Chess::get_color_for_piece(src_knight);
